...
try:
    ...
    from stick_analyzer.adapters.prompt import build_ai_prompt, inject_reference_curves
    ...
    from src.stick_analyzer.adapters.prompt import build_ai_prompt, inject_reference_curves
